...
public final class NoteInfo implements Parcelable {
    ...
    // read values back out from parcel
    private NoteInfo(Parcel parcel) {
        // Everything has to be in the same order as it was written in parcelable
    ...
    public void writeToParcel(Parcel parcel, int flags) {
        parcel.writeParcelable(mCourse,0); // no special handling needed so zero
