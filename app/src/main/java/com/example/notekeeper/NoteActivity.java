...
public class NoteActivity extends AppCompatActivity {
    // add package name in string so it is unique
    ...
    private void readDisplayStateValues(){
        ...
        // in case of new note parcelable will be null
    ...
    private void sendEmail() {
        ...
        String text = "Checkout what I learned at a plural sight course \"" + course.getTitle()
